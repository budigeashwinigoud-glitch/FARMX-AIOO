...
<title>KisanAI 2.0 – Real-time Agriculture Assistant</title>
...
<style>
/* ═══════════════════════════════════════════════════════════
   KISANAI 2.0 — VIBRANT AGRICULTURAL DESIGN SYSTEM
  ...
  <div class="status-left">
    ...
    <div class="status-ticker">
      <div class="ticker-inner" id="ticker">
        🌾 Wheat ₹2,275 ↑ &nbsp;&nbsp; 🌾 Rice ₹2,183 → &nbsp;&nbsp; 🌿 Cotton ₹6,620 ↑ &nbsp;&nbsp; 🌾 Soybean ₹4,180 ↓ &nbsp;&nbsp; 🌽 Maize ₹1,870 → &nbsp;&nbsp; 🧅 Onion ₹2,410 ↑ &nbsp;&nbsp; 🍅 Tomato ₹1,950 ↓ &nbsp;&nbsp; 🥔 Potato ₹1,310 ↑
      </div>
    </div>
  </div>
  <div class="status-right">
    <div class="db-pill">🗄️ MongoDB <span style="color:#7FFF7F">●</span> Connected</div>
    <div class="db-pill">⚡ Socket.io <span style="color:#7FFF7F">●</span> Live</div>
...
<div id="abar">
  <span>🔔</span>
  <span id="atxt">Weather Alert: Heavy rain forecast for Punjab in 24 hrs — secure crops!</span>
  <button class="alert-dismiss" onclick="hideAlert()">✕</button>
</div>
...
<div id="lang-modal">
  <div class="lcard">
    <div class="llogo">🌾</div>
    <h1>KisanAI 2.0</h1>
    <p class="lsub">Powered by Claude AI + Real-time Data &nbsp;•&nbsp; आपकी भाषा चुनें</p>
    <div class="lgrid">
      <button class="lbtn" onclick="selLang(this,'en')">English</button>
      <button class="lbtn" onclick="selLang(this,'hi')">हिंदी<br><small style="font-weight:400">Hindi</small></button>
      <button class="lbtn" onclick="selLang(this,'pa')">ਪੰਜਾਬੀ<br><small style="font-weight:400">Punjabi</small></button>
      <button class="lbtn" onclick="selLang(this,'mr')">मराठी<br><small style="font-weight:400">Marathi</small></button>
      <button class="lbtn" onclick="selLang(this,'te')">తెలుగు<br><small style="font-weight:400">Telugu</small></button>
      <button class="lbtn" onclick="selLang(this,'ta')">தமிழ்<br><small style="font-weight:400">Tamil</small></button>
      <button class="lbtn" onclick="selLang(this,'kn')">ಕನ್ನಡ<br><small style="font-weight:400">Kannada</small></button>
      <button class="lbtn" onclick="selLang(this,'gu')">ગુજરાતી<br><small style="font-weight:400">Gujarati</small></button>
      <button class="lbtn" onclick="selLang(this,'bn')">বাংলা<br><small style="font-weight:400">Bengali</small></button>
    </div>
    <button class="lconfirm" onclick="startApp()">✅ Start / शुरू करें</button>
  </div>
</div>
...
<div class="db-stats" id="db-stats">
  <div class="db-stat">
    ...
    <div class="db-growth">↑ +12 today</div>
  </div>
  <div class="db-stat">
    <div class="db-val" id="db-queries">18,392</div>
    <div class="db-lbl">AI Queries</div>
    <div class="db-growth">↑ Live</div>
  </div>
  <div class="db-stat">
    <div class="db-val" id="db-diagnoses">4,215</div>
    <div class="db-lbl">Leaf Scans</div>
    <div class="db-growth">↑ +47 today</div>
  </div>
  <div class="db-stat">
    <div class="db-val" id="db-saved">₹1.2Cr</div>
    <div class="db-lbl">Farmer Savings</div>
    <div class="db-growth">↑ Estimated</div>
  </div>
</div>

<!-- ── Real-time Price Ticker ───────────────────────────────────────────── -->
<div class="rt-bar">
  <span class="rt-label">📡 Live Mandi</span>
  <div class="rt-price-scroll">
    <div class="rt-prices" id="rt-prices">
      <!-- Duplicated for seamless loop -->
      <span class="rt-price-item">🌾 Wheat <span class="rt-up">₹2,275 ↑</span></span>
      <span class="rt-price-item">🌾 Rice <span>₹2,183 →</span></span>
      <span class="rt-price-item">🌿 Cotton <span class="rt-up">₹6,620 ↑</span></span>
      <span class="rt-price-item">🫘 Soybean <span class="rt-down">₹4,180 ↓</span></span>
      <span class="rt-price-item">🌽 Maize <span>₹1,870 →</span></span>
      <span class="rt-price-item">🧅 Onion <span class="rt-up">₹2,410 ↑</span></span>
      <span class="rt-price-item">🍅 Tomato <span class="rt-down">₹1,950 ↓</span></span>
      <span class="rt-price-item">🥔 Potato <span class="rt-up">₹1,310 ↑</span></span>
      <!-- Duplicate -->
      <span class="rt-price-item">🌾 Wheat <span class="rt-up">₹2,275 ↑</span></span>
      <span class="rt-price-item">🌾 Rice <span>₹2,183 →</span></span>
      <span class="rt-price-item">🌿 Cotton <span class="rt-up">₹6,620 ↑</span></span>
...
<div class="hero">
  <div class="hero-content">
    ...
    <h2>🎙️ बोलो, KisanAI सुन रहा है!</h2>
    <p id="hero-sub">Voice-powered AI assistant for Indian farmers • Real Claude AI responses</p>
    ...
    <div class="micstatus" id="mstatus">Tap mic to speak • या नीचे टाइप करें</div>

    <div class="ctx-row">
      <button class="ctx on" onclick="setCtx(this,'general')">💬 General</button>
      <button class="ctx" onclick="setCtx(this,'crop')">🌱 Crop</button>
      <button class="ctx" onclick="setCtx(this,'disease')">🔬 Disease</button>
      <button class="ctx" onclick="setCtx(this,'market')">📊 Market</button>
      <button class="ctx" onclick="setCtx(this,'weather')">🌤️ Weather</button>
      <button class="ctx" onclick="setCtx(this,'scheme')">🏛️ Scheme</button>
    </div>
    ...
    <div class="chat-row">
      ...
      <button class="sendbtn" onclick="sendChat()" title="Send">➤</button>
    </div>

    <div class="ai-box" id="aibox">
      <div class="ai-head">
        <span class="ai-lbl"><div class="ai-dot"></div> KisanAI Reply</span>
        <button class="spkbtn" onclick="speakEl('aitxt')">🔊 Speak</button>
      </div>
...
<!-- ── Feature Cards ───────────────────────────────────────────────────── -->
<div class="sec-ttl">🚀 Features</div>
<div class="fgrid">
...
<div class="panel" id="cpanel">
  <div class="panel-ttl">🌱 AI Crop Advice & Rotation
    <button class="closebtn" onclick="closePanel('cpanel')">✕ Close</button>
  </div>
  <div class="fg"><label class="fl">Previous Crops Grown (last 1–2 seasons)</label>
  ...
  <button class="subbtn" onclick="getCropAdvice()" id="crop-btn">🌾 Get AI Crop Rotation Plan</button>
  <div class="rbox" id="cr">
    <div class="rhead">
      <span class="rlbl">🤖 Claude AI — Crop Rotation Plan</span>
      <button class="spkbtn" onclick="speakEl('cr-txt')">🔊 Speak</button>
    </div>
...
<div class="panel" id="lpanel">
  <div class="panel-ttl">🔬 AI Leaf Disease Scanner
    <button class="closebtn" onclick="closePanel('lpanel')">✕ Close</button>
  </div>
  ...
  <div class="upzone" onclick="document.getElementById('lfile').click()">
    ...
    <div class="uphint">Clear photo in good light gives best results • Supports JPG, PNG</div>
  </div>
  <div id="lprev" style="display:none;text-align:center;margin-bottom:16px">
    ...
    <div style="font-size:.8rem;color:var(--text-lt);margin-top:6px;font-weight:600">📷 Image ready for AI analysis</div>
  </div>
  <button class="subbtn" onclick="analyzeLeaf()" id="leaf-btn">🔍 Analyze with Claude Vision AI</button>
  <div class="rbox" id="lr">
    <div class="rhead">
      <span class="rlbl">🔬 Claude Vision — Disease Analysis</span>
      <button class="spkbtn" onclick="speakEl('lr-txt')">🔊 Speak</button>
    </div>
...
<div class="panel" id="wpanel">
  <div class="panel-ttl">🌤️ Real-time Weather + AI Farming Advice
    <button class="closebtn" onclick="closePanel('wpanel')">✕ Close</button>
  </div>
  ...
  <button class="subbtn" onclick="getWeather()" id="weather-btn">🌦️ Get Live Weather + AI Advice</button>
  <div class="rbox" id="wr">
    <div class="rhead">
      <span class="rlbl">🌤️ Live Weather Feed</span>
      <button class="spkbtn" onclick="speakEl('w-adv')">🔊 Speak Advice</button>
    </div>
...
<div class="panel" id="mpanel">
  <div class="panel-ttl">📊 Live Market Prices + Sell Timing
    <button class="closebtn" onclick="closePanel('mpanel')">✕ Close</button>
  </div>
  ...
  <button class="subbtn" onclick="getMarket()" id="market-btn">📈 Get Live Prices + AI Sell Advice</button>
  <div class="rbox" id="mr">
    <div class="rhead">
      <span class="rlbl">📊 Mandi Prices — Live</span>
      <button class="spkbtn" onclick="speakEl('m-adv')">🔊 Speak</button>
    </div>
    <table class="ptbl">
...
<div class="panel" id="spanel">
  <div class="panel-ttl">🏛️ Government Agriculture Schemes
    <button class="closebtn" onclick="closePanel('spanel')">✕ Close</button>
  </div>
  ...
  <button class="subbtn" onclick="getSchemes()" id="scheme-btn">🔍 Find Best Schemes for Me</button>
  <div class="rbox" id="sr">
    <div class="rhead">
      <span class="rlbl">🏛️ MongoDB Schemes + AI Eligibility</span>
      <button class="spkbtn" onclick="speakEl('s-ai')">🔊 Speak</button>
    </div>
    <div id="scards"></div>
...
<div class="panel" id="opanel">
  <div class="panel-ttl">📱 Saved Advice — Offline Mode
    <button class="closebtn" onclick="closePanel('opanel')">✕ Close</button>
  </div>
  <div style="background:var(--primary-pale);border-radius:var(--rs);padding:14px;margin-bottom:16px;border:1px solid rgba(0,168,107,.2)">
    <div style="font-weight:700;color:var(--primary-dk);font-size:.9rem;margin-bottom:4px">📡 IndexedDB Offline Cache</div>
  ...
  <button class="subbtn" style="background:linear-gradient(135deg,var(--danger),#FF6B6B);margin-top:16px"
          onclick="clearCache()">🗑️ Clear All Saved Data</button>
</div>
...
<script>
// ═══════════════════════════════════════════════════════════
//  KISANAI 2.0 — COMBINED BACKEND + FRONTEND JAVASCRIPT
//  Real Claude AI • Real-time polls • MongoDB simulation
// ═══════════════════════════════════════════════════════════
...
// ── Static market data (simulates MongoDB collection) ──────
const MARKET_DB = {
  wheat:   { price:2275, unit:'₹/quintal', trend:'rising',   best:'Mar–Apr', change:+25, pct:'+1.1%' },
  rice:    { price:2183, unit:'₹/quintal', trend:'stable',   best:'Nov–Dec', change:+0,  pct:'0%'    },
  cotton:  { price:6620, unit:'₹/quintal', trend:'rising',   best:'Feb–Mar', change:+120,pct:'+1.8%' },
  soybean: { price:4180, unit:'₹/quintal', trend:'falling',  best:'Jan–Feb', change:-120,pct:'-2.8%' },
  maize:   { price:1870, unit:'₹/quintal', trend:'stable',   best:'Sep–Oct', change:+20, pct:'+1.1%' },
  onion:   { price:2410, unit:'₹/quintal', trend:'volatile', best:'Apr–May', change:+10, pct:'+0.4%' },
  tomato:  { price:1950, unit:'₹/quintal', trend:'falling',  best:'Oct–Nov', change:-150,pct:'-7.1%' },
  potato:  { price:1310, unit:'₹/quintal', trend:'rising',   best:'Feb–Mar', change:+110,pct:'+9.2%' },
};

const SCHEMES_DB = [
  { name:'PM-KISAN', full:'Pradhan Mantri Kisan Samman Nidhi', benefit:'₹6,000/year direct to bank in 3 equal installments', docs:'Aadhaar, Bank Passbook, Land Records (Khasra)', apply:'pm-kisan.gov.in or nearest CSC center', color:'#0099FF' },
  { name:'PMFBY', full:'Pradhan Mantri Fasal Bima Yojana', benefit:'Crop insurance — Govt pays 95–98% of premium for you', docs:'Aadhaar, Bank Account, Sowing Certificate', apply:'Nearest bank branch or insurance company', color:'#00A86B' },
  { name:'KCC', full:'Kisan Credit Card', benefit:'Up to ₹3 lakh at just 4% interest for seeds, fertilizer, tools', docs:'Identity Proof, Land Records, 2 Passport Photos', apply:'Any nationalized or cooperative bank', color:'#7C3AED' },
  { name:'eNAM', full:'National Agriculture Market', benefit:'Sell directly to buyers across India — 5–15% better prices', docs:'Aadhaar, Bank Account, Mobile Number', apply:'enam.gov.in (free registration)', color:'#E69500' },
...
const SAVED_DATA = [
  { key:'weather_Ludhiana', icon:'🌤️', prev:'Light rain expected in 48h. Don\'t spray pesticides. Check drainage...', date:'Feb 17, 3:45 PM' },
  { key:'crop_advice', icon:'🌱', prev:'After Rice: Grow Mustard/Wheat this Rabi. Sow by Nov 15 for best yield...', date:'Feb 16, 10:20 AM' },
  { key:'market_wheat', icon:'📊', prev:'Wheat prices rising ₹2,275→₹2,400 by March. Hold stock if storage available...', date:'Feb 15, 2:00 PM' },
  { key:'scheme_kisan', icon:'🏛️', prev:'PM-KISAN: ₹6,000/year. Visit pm-kisan.gov.in with Aadhaar + bank passbook...', date:'Feb 14, 9:15 AM' },
];
...
function initVoice() {
  ...
  if (!SR) { document.getElementById('mstatus').textContent = '⚠️ Voice not supported. Please type your question.'; return; }
  ...
  S.recognition.onstart = () => {
    ...
    document.getElementById('mstatus').textContent = '🎙️ सुन रहा हूँ... Listening now!';
  };
  ...
  S.recognition.onend = () => {
    ...
    if (!document.getElementById('mstatus').textContent.includes('thinking')) {
      document.getElementById('mstatus').textContent = 'Tap mic to speak • या नीचे टाइप करें';
    }
  };
  S.recognition.onerror = e => {
    ...
    document.getElementById('mring2').classList.remove('pulse');
    document.getElementById('micon').textContent = '🎤';
    document.getElementById('mstatus').textContent = `⚠️ ${e.error} — Please type below`;
  };
}
...
function speakText(txt) {
  ...
  S.synth.cancel();
  const clean = txt.replace(/[^\w\s.,!?।₹%/-]/g, ' ').replace(/\s+/g, ' ').trim();
  if (!clean) return;
...
async function sendChat() {
  ...
  document.getElementById('mstatus').textContent = '⏳ AI is thinking...';
  S.queryCount++;
...
${ctxHints[S.ctx] || ''}`;
  ...
  try {
    ...
    saveToCache(`chat_${msg.slice(0,20)}`, { icon: '💬', key: msg.slice(0,30), data: reply });
    document.getElementById('cin').value = '';
    document.getElementById('mstatus').textContent = '✅ Done! Tap mic to ask another question.';
    setTimeout(() => speakText(reply.slice(0, 500)), 200);
  } catch (err) {
    txt.textContent = '⚠️ Connecting to AI... Please check connection and try again.';
    document.getElementById('mstatus').textContent = 'Error — please try again';
  }
}
...
🌾 TOP 3 RECOMMENDED CROPS (with sowing dates and expected yield per acre)
🔄 CROP ROTATION PLAN (for next 12 months)
🌱 SOIL HEALTH BENEFITS
💡 2-3 PRO TIPS specific to their situation
📅 SOWING CALENDAR
...
Use simple farmer-friendly language. Include quantities in familiar units.`;
  ...
  try {
    ...
    saveToCache('crop_advice', { icon: '🌱', key: 'Crop Rotation Plan', data: reply });
    speakText(reply.slice(0, 500));
  } catch { document.getElementById('cr-txt').textContent = '⚠️ Could not connect. Please check your internet.'; rbox.classList.add('show'); }

  btn.disabled = false; btn.innerHTML = '🌾 Get AI Crop Rotation Plan';
}

// ── Leaf Analysis (Real Claude Vision) ─────────────────────────
...
async function analyzeLeaf() {
  ...
  try {
    ...
    saveToCache('leaf_analysis', { icon: '🔬', key: `${crop} Leaf Analysis`, data: analysis });
    speakText(analysis.slice(0, 500));
  } catch { document.getElementById('lr-txt').textContent = '⚠️ Analysis failed. Check internet and try again.'; rbox.classList.add('show'); }

  btn.disabled = false; btn.innerHTML = '🔍 Analyze with Claude Vision AI';
}

// ── Weather (Real API simulation + AI advice) ─────────────────
async function getWeather() {
  ...
  const langNames = { en:'English', hi:'Hindi', pa:'Punjabi', mr:'Marathi', te:'Telugu', ta:'Tamil', kn:'Kannada', gu:'Gujarati', bn:'Bengali' };
  const prompt = `Weather in ${weather.city}: ${weather.temp}°C (feels ${weather.feels}°C), Humidity ${weather.humidity}%, Wind ${weather.wind} km/h, ${weather.condition}, Rainfall ${weather.rainfall}mm, UV ${weather.uv}.
...
Be brief and practical.`;
  ...
  try {
    ...
    document.getElementById('wstats').innerHTML = `
      <div class="wstat"><div class="wval">${weather.temp}°C</div><div class="wlbl">Temperature</div></div>
    ...
    // Generate alerts
    const alerts = [];
    if (weather.temp > 36) alerts.push({ cls:'danger', icon:'🔥', txt:'Heat stress! Water crops before 8 AM and after 5 PM only.' });
    if (weather.humidity > 80) alerts.push({ cls:'danger', icon:'🍄', txt:'High humidity — fungal disease risk is high. Avoid overhead irrigation.' });
    if (weather.rainfall > 5) alerts.push({ cls:'', icon:'🌧️', txt:'Rainfall recorded — hold irrigation for 2-3 days. Check field drainage.' });
    if (weather.wind > 25) alerts.push({ cls:'', icon:'💨', txt:'Strong winds — do NOT spray pesticides today. Support tall crops.' });
    if (weather.uv > 8) alerts.push({ cls:'', icon:'☀️', txt:'Very high UV — protect workers and avoid midday field work.' });
    if (!alerts.length) alerts.push({ cls:'info', icon:'✅', txt:'Good farming conditions today! Ideal time for spraying and field work.' });

    document.getElementById('walerts').innerHTML = alerts.map(a =>
      `<div class="ali ${a.cls}"><span class="ali-icon">${a.icon}</span><div><div class="ali-txt">${a.txt}</div><div class="ali-time">Updated just now • ${city}</div></div></div>`
    ).join('');

    document.getElementById('last-updated').textContent = `📡 Last updated: ${now.toLocaleTimeString('en-IN')} • Source: OpenWeatherMap (simulated)`;
    rbox.classList.add('show');
    typeText('w-adv', advice);
    saveToCache(`weather_${city}`, { icon: '🌤️', key: `Weather: ${city}`, data: advice });
  ...
  } catch { document.getElementById('w-adv').textContent = '⚠️ Weather service unavailable.'; rbox.classList.add('show'); }

  btn.disabled = false; btn.innerHTML = '🌦️ Get Live Weather + AI Advice';
}
...
async function getMarket() {
  ...
  const tArr = { rising:'↑', falling:'↓', stable:'→', volatile:'↕' };
  document.getElementById('ptbody').innerHTML = Object.entries(displayData).map(([c, d]) => `
    <tr>
      ...
      <td><strong>₹${d.price}</strong><span style="font-size:.75rem;color:var(--text-lt)">/${d.unit.split('/')[1]||'q'}</span></td>
      <td><span class="tbadge tr-${d.trend}">${d.trend} ${tArr[d.trend]||'→'}</span></td>
  ...
  const langNames = { en:'English', hi:'Hindi', pa:'Punjabi', mr:'Marathi', te:'Telugu', ta:'Tamil', kn:'Kannada', gu:'Gujarati', bn:'Bengali' };
  const pricesText = Object.entries(displayData).map(([c,d]) => `${c}: ₹${d.price} (${d.trend})`).join(', ');
...
Be practical and honest about uncertainty.`;
  ...
  try {
    ...
    saveToCache('market_prices', { icon: '📊', key: 'Market Price Analysis', data: advice });
  ...
  } catch { document.getElementById('m-adv').textContent = '⚠️ Market service unavailable.'; rbox.classList.add('show'); }

  btn.disabled = false; btn.innerHTML = '📈 Get Live Prices + AI Sell Advice';
}
...
async function getSchemes() {
  ...
  document.getElementById('scards').innerHTML = SCHEMES_DB.map(s => `
    <div class="sc">
      ...
      <div class="sc-detail">📋 <strong>Documents:</strong> ${s.docs}<br>🏢 <strong>Apply at:</strong> ${s.apply}</div>
    </div>`).join('');
...
Be encouraging and use very simple language.`;
  ...
  try {
    ...
    saveToCache('schemes', { icon: '🏛️', key: 'Scheme Recommendations', data: advice });
    speakText(advice.slice(0, 500));
  } catch { document.getElementById('s-ai').textContent = '⚠️ AI unavailable. See scheme cards above for details.'; rbox.classList.add('show'); }

  btn.disabled = false; btn.innerHTML = '🔍 Find Best Schemes for Me';
}

// ── Cache (simulating IndexedDB/MongoDB) ──────────────────────
  ...
  document.getElementById('oitems').innerHTML = items.slice(0, 12).map(item => `
    <div class="offline-item" onclick="speakText('${(item.data||'').slice(0,300).replace(/'/g,"\\'")}')">
      ...
      <div class="oi-body">
        ...
        <div class="oi-meta">
          <span>💾 ${item.timestamp ? new Date(item.timestamp).toLocaleDateString('en-IN') : 'Cached'}</span>
...
function smartAlerts() {
  const alerts = [
    '🌧️ Heavy rain forecast for Punjab in 24 hrs — secure crops and check drainage!',
    '📈 Wheat prices rising — ₹2,275 today. Consider selling by March for peak profit.',
    '🏛️ PM-KISAN next installment due in April — verify your account at pm-kisan.gov.in',
    '🌡️ Heat wave warning in Vidarbha — water cotton crops before 8 AM only',
    '🔔 eNAM: Soybean demand high — register now to get 10% better price!',
  ];
  let i = 0;
  const show = () => {
